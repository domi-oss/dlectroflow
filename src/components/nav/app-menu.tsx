...
export function AppMenu({ voice }: { voice: Voice }) {
  ...
  // Popup entries, at the 44px minimum (WCAG 2.5.5). Named and commented here
  // rather than spelled inline so this file and account-menu.tsx have the same
  // shape — #117 is about the two menus agreeing, so their entry styles should be
  // as easy to diff as possible.
  //
